...
export default function CompletedTask({ task, id }) {
    ...
    return (
        <div className='bg-slate-300 py-4 rounded-lg shadow-md flex items-center justify-center gap-2 mb-3 px-2'>
            ...
            <div className="task-info text-slate-900 text-sm w-10/12">
                <h4 className="task-title text-lg capitalize font-semibold line-through">{task.title}</h4>
                <p className="task-description line-through">{task.description}</p>
